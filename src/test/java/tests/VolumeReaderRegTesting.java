...
public class VolumeReaderRegTesting {
	...
	public void firstPrint() {
		VolumeFromProductName finalVolume = reader.readVolumeFromProductName("Brat 1.400g");
	...
	public void readVolume11aDavka() {
		VolumeFromProductName finalVolume = reader.readVolumeFromProductName("Prasek 80 dávek");
